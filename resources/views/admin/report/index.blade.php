                        ...
                        @foreach($reports as $report)
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-primary" onclick="location.href='{{route('admin.report.view',['id' => $report->id])}}'">詳細</button>
                                    <button type="button" class="btn btn-info" onclick="location.href='{{route('admin.report.output',['id' => $report->id])}}'">PDF</button>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
